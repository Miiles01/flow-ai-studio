...
const PresenceStack = ({ users }: { users: PresenceUser[] }) => {
        ...
        <Tooltip key={u.id + i}>
          <TooltipTrigger asChild>
            <motion.div
              ...
              className="w-7 h-7 rounded-full ring-2 ring-white overflow-hidden flex items-center justify-center text-[10px] font-medium text-white"
