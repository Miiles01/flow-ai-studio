  ...
  return (
    <>
      ...
      <div className="fixed top-6 left-1/2 -translate-x-1/2 w-[95vw] md:w-max z-50 flex flex-col gap-2">
        ...
        <nav className="w-full flex items-center justify-between gap-4 md:gap-16 px-6 md:px-8 py-2.5 bg-white/80 backdrop-blur-2xl border border-black/5 rounded-full shadow-[0_25px_50px_-12px_rgba(0,0,0,0.25)]">
