      ...
      <AnimatePresence>
        {showInput && (
          <motion.div
            ...
            className={`absolute top-[calc(100%+10px)] left-1/2 z-50 flex items-center gap-2 rounded-2xl px-3 py-2.5 border ${isDark ? 'bg-[#1C1C1E] border-white/10' : 'bg-white border-[#F3F4F6]'} shadow-xl`}
            style={{ minWidth: 300 }}
            onMouseDown={(e) => e.stopPropagation()}
          >
