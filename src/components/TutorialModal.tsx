...
const mercadoLibreLogo = (
  <svg className="h-4 w-auto text-black dark:text-white shrink-0" viewBox="1338.7 1396.4 150.1 135.8" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
const lorealLogo = (
  <svg className="h-4 w-auto text-black dark:text-white shrink-0" enableBackground="new 0 0 2498.1 452" viewBox="0 0 2498.1 452" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
const tiktokLogo = (
  <svg className="h-4 w-auto text-black dark:text-white shrink-0" viewBox="0 0 296.96 80.12982445231711" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
const amazonLogo = (
  <svg className="h-4 w-auto text-black dark:text-white shrink-0" viewBox="-0.658000000000003 -1.875 384.24600000000004 119.917" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
const airbnbLogo = (
  <svg className="h-4 w-auto text-black dark:text-white shrink-0" viewBox="329.775 439.999 320.426 100.002" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
const shopifyLogo = (
  <svg className="h-4 w-auto text-black dark:text-white shrink-0" viewBox="0 0 100 28.6" xmlns="http://www.w3.org/2000/svg">
    <g>
                      ...
                      <div className="w-full overflow-hidden" style={{ maskImage: "linear-gradient(to right, transparent, black 15%, black 85%, transparent)", WebkitMaskImage: "linear-gradient(to right, transparent, black 15%, black 85%, transparent)" }}>
                        <div className="flex w-max gap-3.5 animate-marquee">
                          {brandsRow1.map((b, idx) => (
                            <div key={idx} className={`flex items-center justify-center px-4 py-2.5 rounded-xl border backdrop-blur-md shrink-0 ${
                              isDark 
