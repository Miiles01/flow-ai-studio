    ...
    nodes: [
      ...
      },
      {
        ...
        data: {
          ...
          details: [
            { id: "c1", dx: -440, dy: -280, side: "left", tag: "Señal", icon: iconPlay, confidence: "likely", label: "Retención de 3 segundos", sublabel: "¿Deslizan o se quedan? Si la mayoría hace scroll antes del segundo 3, no hay ronda 2." },
            { id: "c2", dx: -440, dy: -120, side: "left", tag: "Señal", icon: iconHeart, confidence: "likely", label: "Likes y comentarios tempranos", sublabel: "La reacción de la muestra pesa más por ser pocos: cada like cuenta mucho." },
            { id: "c3", dx: -440, dy: 40, side: "left", tag: "Señal", icon: iconShare, confidence: "likely", label: "Compartidos y guardados", sublabel: "Las señales más caras de conseguir: valen más que cualquier like." },
          ],
        },
      },
      {
        ...
        data: {
          ...
          details: [
            { id: "d1_tk", dx: -440, dy: -40, side: "left", tag: "Concept Drift", label: "Intereses efímeros", sublabel: "TikTok asume que el interés de un usuario cambia en minutos. Si tu video encaja en la tendencia exacta del minuto, escala rápido." }
          ],
        },
      },
      {
      ...
      },
      {
        ...
        data: {
          ...
          details: [
            { id: "g1", dx: 340, dy: -140, side: "right", tag: "Métrica", confidence: "hypothesis", label: "Benchmark de interacción", sublabel: "Arriba de 6-8% de interacción en la ronda semilla suele escalar. Debajo de 3%, difícil." },
            { id: "g2", dx: 340, dy: 20, side: "right", tag: "Tip", label: "Responde comentarios con video", sublabel: "Cada respuesta reinicia el ciclo de distribución del video original." },
          ],
        },
      },
      {
    ...
    nodes: [
      ...
      },
      {
        ...
        data: {
          ...
          details: [
            { id: "d1", dx: -440, dy: -280, side: "left", tag: "Señal", icon: iconPlay, confidence: "likely", label: "Retención de 3 segundos", sublabel: "% de gente que pasa del tercer segundo. Benchmark sano: 60% o más." },
            { id: "d2", dx: -440, dy: -120, side: "left", tag: "Señal", icon: iconHeart, confidence: "likely", label: "Interacción temprana", sublabel: "Likes y comentarios de la muestra; Instagram compara contra reels similares." },
            { id: "d3", dx: -440, dy: 40, side: "left", tag: "Tip", label: "Cómo mejorar el hook", sublabel: "Movimiento + texto grande en el primer frame. Sin intros: directo al valor." },
          ],
        },
      },
      {
      ...
      },
      {
        ...
        data: {
          ...
          details: [
            { id: "g1", dx: -440, dy: -100, side: "left", tag: "Arquitectura", label: "Two-Tower Model", sublabel: "Dos redes neuronales (una para ti, otra para el post) mapean el contenido usando embeddings calculados offline." },
            { id: "g2", dx: -440, dy: 60, side: "left", tag: "Cálculo", label: "Value Model (VM)", sublabel: "Score = W_click × P(click) + W_like × P(like) − W_seeless × P(ver menos)." },
            { id: "g3", dx: -440, dy: 220, side: "left", tag: "Integridad", label: "Diversidad de Feed", sublabel: "Regla estricta: nunca muestra más de 3 posts seguidos de la misma cuenta." }
          ],
        },
      },
    ],
    ...
    nodes: [
      ...
      },
      {
        ...
        data: {
          ...
          details: [
            { id: "c1", dx: -440, dy: -120, side: "left", tag: "Señal", icon: iconLike, confidence: "confirmed", label: "Señales activas", sublabel: "Comentarios, compartidos y reacciones: las que más pesan." },
            { id: "c2", dx: -440, dy: 40, side: "left", tag: "Señal", icon: iconPlay, confidence: "confirmed", label: "Señales pasivas", sublabel: "Tiempo de visualización y clics: pesan menos, pero suman." },
          ],
        },
      },
      {
    ...
    nodes: [
      ...
      },
      {
        ...
        data: {
          ...
          details: [
            { id: "b1_yt", dx: -440, dy: -40, side: "left", tag: "ML", label: "Nearest Neighbor Search", sublabel: "Encuentra videos similares a ti en un espacio de embeddings gigante y de forma ultra rápida." }
          ],
        },
      },
      {
        ...
        data: {
          ...
          details: [
            { id: "c1", dx: -440, dy: -120, side: "left", tag: "Métrica", icon: iconPlay, confidence: "confirmed", label: "Viewed vs. Swiped", sublabel: "La métrica clave de Shorts: % que decide quedarse al ver el primer frame." },
            { id: "c2", dx: -440, dy: 40, side: "left", tag: "Tip", label: "El primer fotograma", sublabel: "Trátalo como una miniatura: composición clara y texto legible." },
          ],
        },
      },
      {
