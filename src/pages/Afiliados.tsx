...
const Afiliados = () => {
  ...
  useEffect(() => {
    ...
    e046Style.textContent = [
      ...
      '.mwg_effect046 .sentence { width: 90%; max-width: 1200px; font-family: "Manrope", sans-serif; font-size: 6.5vw; line-height: 1.05; font-weight: 500; letter-spacing: -0.04em; text-align: left; }',
