    ...
    <div className={`w-screen h-screen overflow-hidden relative flex flex-col transition-colors duration-300 ${isDark ? 'dark bg-[#0f0f11]' : 'bg-background'}`}>
          ...
          <>
            ...
            <AnimatePresence>
              <motion.div
                ...
                className={`flex items-center gap-1 rounded-xl shadow-sm px-2 py-1.5 pointer-events-auto ${isDark ? 'bg-[#1C1C1E] border border-white/10 text-white' : 'bg-white border border-gray-100/50 text-black'}`}
              >
                ...
                <div className="relative">
                  ...
                  {groupPicker === "fill" && (
                    <div className="absolute bottom-full mb-2 left-1/2 -translate-x-1/2 bg-white rounded-xl shadow-sm border border-gray-100 p-2 grid grid-cols-5 gap-1 z-[10000] w-[140px]">
      ...
      <AnimatePresence>
        {isMobile && showMobileWarning && (
          ...
          >
            <div className="bg-black text-white text-[13px] font-normal px-5 py-3 rounded-2xl shadow-sm max-w-sm text-center pointer-events-auto">
                    ...
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <button
                          ...
                          className={`w-fit h-11 flex items-center justify-center gap-3 px-4 rounded-full transition-all duration-200 shrink-0 shadow-sm border ${
                            copiedAll
                    ...
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <button
                          ...
                          className={`w-11 h-11 flex items-center justify-center rounded-full transition-all duration-200 shrink-0 shadow-sm border ${
                            downloadedAll
