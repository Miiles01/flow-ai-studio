    ...
    >
      <div className="text-center mb-10">
        <Link to="/" className="inline-block mb-8 hover:opacity-80 transition-opacity">
          <img src={logotipoSvg} alt="miiles" className="h-8 mx-auto" />
        </Link>
        <h1 className="text-[28px] font-medium text-foreground">Crear cuenta</h1>
      </div>

      <form onSubmit={handleRegister} className="space-y-5">
        <div className="relative">
          <User size={18} className="absolute left-4 top-1/2 -translate-y-1/2 text-miiles-gray-400" />
          <Input
            type="text"
        ...
        <div className="flex justify-center mt-8">
          <button
            type="submit"
            className="w-auto px-16 min-w-[200px] h-14 rounded-full bg-black text-white font-medium hover:-translate-y-1 transition-transform disabled:opacity-50 disabled:pointer-events-none"
            disabled={loading}
          >
      ...
      <Button variant="outline" className="w-full rounded-full h-14 border-border hover:bg-gray-50" onClick={handleGoogleLogin}>
