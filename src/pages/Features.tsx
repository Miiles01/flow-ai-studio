            ...
            <AnimatePresence>
              {isFlyoutOpen && (
                <motion.div
                  ...
                  className="absolute left-[calc(100%+16px)] top-1/2 -translate-y-1/2 w-[128px] bg-[#111] p-3 rounded-2xl shadow-[0_16px_48px_rgba(0,0,0,0.3)] grid grid-cols-2 gap-2 z-50 pointer-events-none"
                >
                  {/* Rectangulo */}
